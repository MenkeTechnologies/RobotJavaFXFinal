...
public class EchoServer implements  Runnable, Cloneable{
    ...
    public void handleConnect(Socket s) {
        ...
        // However we don't want to call the ServerApplication.EchoServer constructor to get this.
        ...
        // derived class instead of the ServerApplication.EchoServer.
        ...
        try {
            ...
            System.out.println("ServerApplication.EchoServer.handleConnect Clone error: "+e);
        }
    }
    public void run()
    {
    ...
    {
        System.out.println("ServerApplication.EchoServer.processStream begins");
    ...
    public void processNextLine(Scanner input, PrintStream ps)
    {
        ...
        ps.println(s);
        System.out.println("ServerApplication.EchoServer echoed: "+s);
    }
...
//
//        ServerApplication.EchoServer es = new ServerApplication.EchoServer();
//        es.monitorServer();
//        System.out.println("Exitting ServerApplication.EchoServer");
//
//    }
